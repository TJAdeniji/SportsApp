...
<body>
	...
	<p class="d-flex justify-content-center">Already registered? Login <a href="/login"> here.</a></p> 
		
		<div class="d-flex justify-content-center">
		<form:form class="w-50 row g-3" action="/register" method="post" modelAttribute="newUser">
